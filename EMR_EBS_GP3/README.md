...
Note: You can change the script if you need but the script does not override the baseline gp3 throughput and IOPS settings so you get the minimum 125MB/s and 3000 IOPs per volume (which is already the maximum IOPS for a gp2 volume).
